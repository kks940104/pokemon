...
public class ApiFileControllerTest {
    ...
    void test1() throws Exception{
        /*
          MockMultipartFile
         */
        MockMultipartFile file1 = new MockMultipartFile("file", "test1.png", MediaType.IMAGE_PNG_VALUE, new byte[]{1,2,3,4,5});
        MockMultipartFile file2 = new MockMultipartFile("file", "test2.png", MediaType.IMAGE_PNG_VALUE, new byte[]{6,7,8,9,10});
        ...
        List<FileInfo> items = fileInfoService.getList("testgid");
    ...
    @Test
    void test2() {
        FileInfo item = fileInfoService.get(1L);
        System.out.println(item);

        List<FileInfo> items = fileInfoService.getList("testgid", null, null);
